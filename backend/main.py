...
def create_war_dead_table():
    """
    Function to create the war_dead_archive table.
    Run this once or execute the SQL in Supabase SQL Editor.
    """
    sql = """
    ...
    """
    print("To create the table, run the following SQL in your Supabase Dashboard:")
    print(sql)
    # Note: supabase-py client does not support raw SQL execution without extensions.

if __name__ == "__main__":
    # If run directly, try to 'create' (print instructions)
    create_war_dead_table()
